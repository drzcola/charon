...
def getKerberosTGT(clientName, password, domain, lmhash, nthash, aesKey='', kdcHost=None, requestPAC=True, serverName=None, kerberoast_no_preauth=False, kdcOptions=None):
    ...
    opts = list(kdcOptions) if kdcOptions is not None else [
...
def getKerberosTGS(serverName, domain, kdcHost, tgt, cipher, sessionKey, renew = False, kdcOptions=None):
